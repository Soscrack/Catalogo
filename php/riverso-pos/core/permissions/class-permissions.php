...
class Riverso_POS_Permissions {
    ...
    const CAPABILITIES = [
        ...
        'riverso_do_inventory'       => 'Realizar conteos de inventario',
        'riverso_manage_inventory_orders' => 'Crear y gestionar órdenes de inventario',
        'riverso_manage_sort_orders'      => 'Crear y gestionar órdenes de ordenar',
        'riverso_view_inventory_history' => 'Ver historial de conteos',
