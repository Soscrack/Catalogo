...
class Riverso_Task_Module {
    ...
    const TASK_TYPES = [
        ...
        'asignar_regla_precio' => 'Asignar regla de precio',
        ...
        'confirmar_unidades_compra' => 'Confirmar unidades de compra',
    ...
    const TASK_TYPE_CATEGORY = [
        ...
        'confirmar_unidades_compra' => 'precios',
        'verificar_etiquetado' => 'productos',
        'aprobar_lista_precios' => 'precios',
        'asignar_regla_precio' => 'precios',
        'cotizacion' => 'precios',
        'picking' => 'inventario',
