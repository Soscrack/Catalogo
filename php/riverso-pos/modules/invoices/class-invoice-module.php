...
class Riverso_Invoice_Module {
    ...
    public function ajax_save_invoice_settings() {
        ...
        if (!empty($_POST['label_print_agent_url'])) {
            update_option('riverso_label_print_agent_url', esc_url_raw($_POST['label_print_agent_url']));
        }
        if (isset($_POST['label_print_auth_token'])) {
            update_option('riverso_label_print_auth_token', sanitize_text_field($_POST['label_print_auth_token']));
        }
