...
define('RIVERSO_POS_VERSION', '1.8.12');
...
final class Riverso_POS {
    ...
    private function load_modules() {
        ...
        $module_list = [
            ...
            'emparejamientos' => [
                'file' => 'class-emparejamiento-module.php',
                'class' => 'Riverso_Emparejamiento_Module',
                'paths' => [
                    RIVERSO_POS_PLUGIN_DIR . 'modules/emparejamientos/class-emparejamiento-module.php',
                ],
            ],
            ...
            'competencia' => [
                'file'  => 'class-competencia-module.php',
                'class' => 'Riverso_Competencia_Module',
                'paths' => [
                    RIVERSO_POS_PLUGIN_DIR . 'modules/competencia/class-competencia-module.php',
                ],
            ],
            ...
            'integrations/tpv' => [
                'file'  => 'class-tpv-module.php',
                'class' => 'Riverso_Tpv_Module',
                'paths' => [
                    RIVERSO_POS_PLUGIN_DIR . 'modules/integrations/tpv/class-tpv-module.php',
                ],
            ],
        ];
