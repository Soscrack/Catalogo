...
(function() {
    ...
    function renderProduct(product) {
        ...
        const printBtn = typeof RiversoLabelPrint !== 'undefined' ? `
            <button type="button" class="print-label-btn" 
                data-sku="${escBarcode(product.sku)}" 
                data-nombre="${escBarcode(product.nombre)}"
                data-precio="${product.precio || 0}"
                style="margin-top:12px;width:100%;padding:8px;background:var(--primary);color:white;border:none;border-radius:4px;cursor:pointer;font-weight:600;">
                🖨️ Imprimir etiqueta
            </button>
        ` : '';
    ...
    // Manejador de botones de impresión en el portal
